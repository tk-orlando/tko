...
add_action('delete_attachment', 'emg_delete_resized_images');

function easymedia_resizer($url, $orig_w, $orig_h, $width, $height, $crop=true, $align='c', $retina=false) {

  global $wpdb;

  // Get common vars
  $args = func_get_args();
  $common = emg_common_info($args);
...
function emg_common_info($args) {

  // Unpack arguments
  list($url, $orig_w, $orig_h, $width, $height, $crop, $align, $retina) = $args;
...
function emg_delete_resized_images($post_id) {
