...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 90);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 90);							// Default thumbnail height. Allows overrid in timthumb-config.php
...
/*------------------------------------------------------------------------------------------------------------*/
/* By GhozyLab ( check if tilde is found in src )															  */
/*------------------------------------------------------------------------------------------------------------*/
