...
{FLBuilderLayout._destroy();FLBuilderLayout._initClasses();FLBuilderLayout._initAnchorLinks();FLBuilderLayout._initBackgrounds();FLBuilderLayout._initModuleAnimations();FLBuilderLayout._initForms();},_destroy:function()
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='http://127.0.0.1/tko/wp-admin/admin-ajax.php';var flBuilderUrl='http://127.0.0.1/tko/wp-content/plugins/beaver-builder-lite-version/';;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();